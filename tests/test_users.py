...
sys.path.append('../test_demo') # imports python file from parent directory
...
class UsersTests(unittest.TestCase):
    ...
    def test_invalid_username_registration(self):
        ...
        response2 = self.register('tksadkbfhskdbajkdalssdsalvklskasdla', 'test@example.com', 'FlaskIsAwesome')
